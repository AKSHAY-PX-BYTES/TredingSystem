...
/// <summary>
/// Suggests portfolio rebalancing based on signal performance and diversification.
/// Analyzes concentration risk and sector allocation.
/// </summary>
public class PortfolioAdvisorAgent : BaseAgent
{
    ...
    protected override async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        // Analyze sector concentration from recent signals
        ...
        // Check sector over-concentration
        ...
        // Check for bearish sentiment alignment
        ...
        // Check for high-confidence buy opportunities
