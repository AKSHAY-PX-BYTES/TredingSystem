...
/// <summary>
/// Sends email/push notifications when signals trigger.
/// Monitors high-confidence signals and alerts users.
/// </summary>
public class AlertAgent : BaseAgent
{
    ...
    private readonly HashSet<string> _sentAlerts = new(); // Prevent duplicate alerts
    ...
    protected override async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        // Cleanup old alert keys (keep only last 2 hours)
